        ...
        <div className="bg-gradient-to-r from-slate-800 to-slate-700 rounded-xl p-5 text-white">
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-wrap gap-2">
              <a
                href="mailto:?subject=Join%20me%20on%20Backcountry%20Crews&body=Check%20out%20Backcountry%20Crews%20-%20find%20partners%20for%20outdoor%20adventures%20in%20Crested%20Butte!%0A%0Ahttps://backcountrycrews.com"
              ...
              <a
                href="sms:?body=Check%20out%20Backcountry%20Crews%20-%20find%20partners%20for%20outdoor%20adventures%20in%20Crested%20Butte!%20backcountrycrews.com"
                className="inline-flex items-center gap-2 px-4 py-2 bg-white text-slate-800 rounded-lg font-medium hover:bg-slate-100 transition-colors text-sm"
              >
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <button
                onClick={() => {
                  navigator.clipboard.writeText('Check out Backcountry Crews - find partners for outdoor adventures in Crested Butte! backcountrycrews.com');
                  alert('Link copied!');
                }}
